...
struct RealityKitView: UIViewRepresentable {
    ...
    final class Coordinator: NSObject {
        ...
        /// Updated every `updateUIView` so scene callbacks see current hand state.
        ...
        /// Puts the sculptable sphere in front of the user once ARKit has a camera pose (fixed world origin is often invisible).
